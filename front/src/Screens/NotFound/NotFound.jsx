  ...
  return (
    <div className="container not-found">
      <div className="Wrap">
        ...
        <svg className={"svgWrap_1 neon-svg"} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 700 250">
          <g>
            <path id="id3_1"
        ...
        {error ? <p className="error-msg">{error}</p> : <h2>Page Not Found</h2>}
    </div>
    </div>
  )
}